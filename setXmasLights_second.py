...
for date in datetime_range(start, end):
    ...
    on_jobAM  = cron.new(command='/root/homeAutomation/on.py 2 >> /var/log/cron/lights_xmas.log')
    off_jobAM = cron.new(command='/root/homeAutomation/off.py 2  >> /var/log/cron/lights_xmas.log')
    on_jobPM  = cron.new(command='/root/homeAutomation/on.py 2 >> /var/log/cron/lights_xmas.log')
    off_jobPM = cron.new(command='/root/homeAutomation/off.py 2 >> /var/log/cron/lights_xmas.log')
